        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <p className="text-gray-300">mundodesenvolvimentoinfantil@gmail.com</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                <p className="text-gray-300">Av. do Contorno, 6321 - 6º andar</p>
                <p className="text-gray-400 text-sm">Bairro São Pedro, Belo Horizonte - MG</p>
              </div>
            </div>
          </div>
